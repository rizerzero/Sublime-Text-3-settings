...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('assets/theme/vendors/bootstrap/bootstrap.min.css')}}" rel="stylesheet">
    ...
    <body class="nav-md">
        ...
        <script src="{{asset('assets/theme/vendors/js/bootstrap.min.js')}}"></script>

        <!-- chart js -->
        <script src="{{asset('assets/theme/vendors/js/chartjs/chart.min.js')}}"></script>
        <!-- bootstrap progress js -->
        <script src="{{asset('assets/theme/vendors/js/progressbar/bootstrap-progressbar.min.js')}}"></script>
        <script src="{{asset('assets/theme/vendors/js/nicescroll/jquery.nicescroll.min.js')}}"></script>
        <!-- icheck -->
        <script src="{{asset('assets/theme/vendors/js/icheck/icheck.min.js')}}"></script>

        <script src="{{asset('assets/theme/vendors/js/custom.js')}}"></script>


        <!-- Datatables -->
        <script src="{{asset('assets/theme/vendors/js/datatables/js/jquery.dataTables.js')}}"></script>
        <script src="{{asset('assets/theme/vendors/js/datatables/tools/js/dataTables.tableTools.js')}}"></script>
        <script>
...
$(document).ready(function () {
    var oTable = $('#example').dataTable({
        ...
        "dom": 'T<"clear">lfrtip',
        "tableTools": {
            "sSwfPath": "{{asset('assets/theme/vendors/js/Datatables/tools/swf/copy_csv_xls_pdf.swf')}}"
        }
    });
